...
This file provides guidance to developers and to any AI coding assistant working in this repository. `CLAUDE.md` is a symlink to it for tools that look for that name.
...
This repository is a fork of `jkuri/Reframed` (remote `upstream`). Development is test-driven and planned in-repo.
