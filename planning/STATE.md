...
- Milestone 06 integrates milestones 03–05 on `milestone-06-agent-tools-editing`; mutating tools, confirmations, grouped undo, and live activity UI are next.
...
1. Write milestone 06's spec and tests, then implement mutating tools, confirmations, grouped undo, and live activity UI.
