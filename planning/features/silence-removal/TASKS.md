...
- [x] 5. UI: `Reframed/Editor/PropertiesPanel+SilencesSection.swift` (`SilenceRemovalSection`) wired into the Video tab; `make build` warning-free; manual checks recorded in the milestone `VERIFY.md`.
