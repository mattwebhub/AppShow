...
| P7 primitives | silence preview/removal, text CRUD, confirmed image import and CRUD, compact overlay results | green |
| P8 runtime E2E | both providers call a read and mutation through the shim | planned |
