...
| P2 cuts | exact keep-slice operations, normalization, undo | planned |
| P3 batches | one undo entry, timeout, user-undo cancellation | planned |
| P4 confirmations | allow/deny/expiry and normalized-operation binding | planned |
| P5 bridge/UI | authenticated tool listing, live activity badge and timeline highlight | planned |
