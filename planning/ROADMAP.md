...
| 06 | agent-tools-editing | Feature 04 part 2: mutating tools for existing editor features with live feedback and undo | in progress: primitive integration and provider E2E |
| 07 | primitives | Text overlay, image overlay, blur, silence detection, transitions, each shipped with its tool | silence, text, and image code complete; integration in progress |
