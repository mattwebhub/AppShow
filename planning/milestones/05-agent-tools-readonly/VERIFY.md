...
| No upstream source edits | compare with `milestone-03-music-tracks` | production changes confined to `AppShow/Agent/Tools/` plus source registration in `project.pbxproj` | pass (2026-09-04) |
