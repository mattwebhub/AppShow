...
| No bypass flags | `make test T=AgentSecurityTests` plus source grep | green | pass: 6 tests; neither bypass flag appears under `Reframed/` |
...
Automated gate completed on 2026-09-04. The milestone remains open until the manual rows above are exercised with a disposable project and real installed providers. PR: https://github.com/mattwebhub/Reframed/pull/6
