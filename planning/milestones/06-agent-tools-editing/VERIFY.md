...
| `make test` | all green | pass, 657 tests in 73 suites (2026-09-04) |
...
| Primitive integration | `get_silences`, guarded removal, and text/image/blur CRUD update compact results and undo | pass, 22 mutation tests plus catalog/dispatcher/socket suites (2026-09-04) |
