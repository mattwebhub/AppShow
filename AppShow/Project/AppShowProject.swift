...
struct AppShowProject: Sendable {
  var bundleURL: URL
    ...
    -> AppShowProject
  {
    ...
    return AppShowProject(bundleURL: bundleURL, metadata: metadata)
  }

  static func open(at url: URL) throws -> AppShowProject {
    ...
    let project = AppShowProject(bundleURL: url, metadata: metadata)
