    ...
    return Canvas { context, size in
      ...
      while t <= duration {
        ...
        if isMajor {
          ...
          context.stroke(tickPath, with: .color(AppShowColors.primaryText), lineWidth: 1)
          ...
          context.stroke(tickPath, with: .color(AppShowColors.primaryText.opacity(0.5)), lineWidth: 0.5)
        }
        t += minorInterval
      }
    }
